...
const MOCK_DOCUMENTS = [
  {
    ...
    licenseNumber: 'FSSAI-11520000012345',
    issueDate: '2023-08-24',
    // Set to expire in 14 days for "Expiring Soon"
    expiryDate: new Date(new Date().setDate(new Date().getDate() + 14)).toISOString().split('T')[0],
    uploadedFile: 'fssai-licence.pdf',
    uploadDate: '2023-08-10',
    lastUpdated: '2023-08-12',
    rejectionReason: null,
    history: [
      { event: 'Document Uploaded', date: '10 Aug 2023' },
      { event: 'Verified by Admin', date: '12 Aug 2023' }
    ]
  },
  {
    id: '2',
    ...
    expiryDate: null,
    uploadedFile: 'gst-cert-2024.pdf',
    uploadDate: '2024-01-15',
    lastUpdated: '2024-01-15',
    rejectionReason: null,
    history: [
      { event: 'Document Uploaded', date: '15 Jan 2024' }
    ]
  },
  {
    id: '3',
    ...
    verification: 'Verified',
    licenseNumber: 'FSC/2023/9912',
    issueDate: '2023-05-10',
    // Set to expired 10 days ago
    expiryDate: new Date(new Date().setDate(new Date().getDate() - 10)).toISOString().split('T')[0],
    uploadedFile: 'fire-noc.pdf',
    uploadDate: '2023-05-08',
    lastUpdated: '2023-05-10',
    rejectionReason: null,
    history: [
      { event: 'Document Uploaded', date: '08 May 2023' },
      { event: 'Verified by Admin', date: '10 May 2023' }
    ]
  },
  {
    id: '4',
    ...
    verification: 'Verified',
    licenseNumber: 'BR-9921',
    issueDate: '2024-02-01',
    expiryDate: '2027-02-18',
    uploadedFile: 'shop-act.jpg',
    uploadDate: '2024-02-01',
    lastUpdated: '2024-02-02',
    rejectionReason: null,
    history: [
      { event: 'Document Uploaded', date: '01 Feb 2024' },
      { event: 'Verified by Admin', date: '02 Feb 2024' }
    ]
  },
  {
    id: '5',
  ...
  },
  {
    ...
    issueDate: '',
    expiryDate: '',
    uploadedFile: 'shop-licence.pdf',
    uploadDate: '2024-05-01',
    lastUpdated: '2024-05-02',
    rejectionReason: 'Correction required',
    history: [
      { event: 'Document Uploaded', date: '01 May 2024' },
      { event: 'Rejected by Admin', date: '02 May 2024' }
    ]
  }
];
