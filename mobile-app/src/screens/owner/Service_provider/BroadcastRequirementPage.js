  ...
  return (
    <View style={styles.wrapper}>
      ...
      <View style={[styles.pageHeader, isMobile && styles.pageHeaderMobile]}>
        ...
        <View>
          <Text style={styles.pageTitle}>Post Requirement</Text>
...
const styles = StyleSheet.create({
  ...
  urgencyBtn: { flex: 1, height: 38, borderRadius: 8, borderWidth: 1, borderColor: colors.border, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center' },
  urgencyBtnActive: { backgroundColor: '#EFF6FF', borderColor: '#2563EB' },
  urgencyBtnText: { fontSize: 12, fontWeight: '600', color: '#64748B' },
  ...
  secondaryBtn: { flex: 1, minWidth: 140, height: 44, borderRadius: 10, backgroundColor: '#F1F5F9', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.border },
