...
import { ArrowLeft, CircleCheck as CheckCircle, Building, ShieldCheck, MapPin } from 'lucide-react-native';
...
const styles = StyleSheet.create({
  ...
  switchesRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 16, marginTop: 4 },
  switchBox: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  switchLabel: { fontSize: 13, fontWeight: '600', color: '#0F172A' },

  submitWrapper: { marginTop: 18, alignItems: 'center' },
  submitBtn: { backgroundColor: NAVY, paddingHorizontal: 36, paddingVertical: 12, borderRadius: 10, width: Platform.OS === 'web' ? 'auto' : '100%', alignItems: 'center' },
  ...
  secondarySuccessBtn: { backgroundColor: '#F8FAFC', paddingVertical: 12, borderRadius: 10, alignItems: 'center', width: '100%', borderWidth: 1, borderColor: colors.border },
  secondarySuccessText: { color: '#0F172A', fontSize: 14, fontWeight: '700' }
});
