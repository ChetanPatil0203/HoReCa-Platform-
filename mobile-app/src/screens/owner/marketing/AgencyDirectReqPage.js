      ...
      <View style={styles.wrapper}>
        <View style={styles.successContainer}>
          ...
          <Text style={styles.successDesc}>
            This requirement has been sent ONLY to {agency?.name || 'the selected agency'}.
          </Text>
    ...
    <View style={styles.wrapper}>
      ...
      <View style={[styles.pageHeader, isMobile && styles.pageHeaderMobile]}>
        ...
        <View>
          ...
          <Text style={styles.pageSubtitle}>Send directly to {agency?.name || 'Selected Agency'}</Text>
        </View>
      </View>
          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.uploadSection}>
              <View style={styles.uploadBox}>
                ...
                <Text style={styles.uploadTitle}>Upload Assets</Text>
                <Text style={styles.uploadSubtitle}>PDF, ZIP (Guidelines, Logo)</Text>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  uploadBox: { flex: 1, height: 100, borderWidth: 1, borderColor: colors.border, borderStyle: 'dashed', borderRadius: 12, backgroundColor: '#F8FAFC', alignItems: 'center', justifyContent: 'center' },
